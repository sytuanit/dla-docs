...
Il modulo **Entrate Ricorrenti** ti aiuta a gestire le fonti di reddito regolari come:
- Stipendio mensile
- Reddito da affitto
- Pensione
...
Questo modulo crea automaticamente **occorrenze** basate sul ciclo che configuri e ti ricorda quando è il momento di ricevere il pagamento.

## 2. Quando usare

Usa questo modulo se hai:
- Entrate fisse secondo un programma (settimanale, bisettimanale o mensile)
- Bisogno di monitorare e confermare quando il pagamento è stato ricevuto
- Desideri un calcolo automatico nel budget mensile

## 3. Schermate associate

- Elenco delle entrate ricorrenti
- Aggiungere una nuova entrata ricorrente
- Modificare un'entrata ricorrente
- Cronologia delle occorrenze

## 4. Utilizzo principale

### 4.1 Aggiungere una nuova entrata ricorrente

1. Vai a **Funzioni** → Seleziona **Entrate Ricorrenti**
2. Premi il pulsante **➕** (FAB) in basso a destra
3. Compila le informazioni:
   - **Categoria**: Seleziona una categoria o creane una nuova
   - **Importo**: Inserisci l'importo dell'entrata (può essere lasciato vuoto, da inserire alla conferma)
...
### 4.2 Confermare la ricezione del pagamento

1. Vai all'elenco delle entrate ricorrenti
...
### 4.3 Modificare un'entrata ricorrente
...
### 4.5 Disattivare/attivare un'entrata
...
- Quando confermi l'entrata, l'applicazione aggiorna automaticamente il budget del mese corrente (se esiste)
- L'entrata viene calcolata in "Entrate Ricorrenti" nel budget
