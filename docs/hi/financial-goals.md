...
│  Forecast                                │
│  ┌───────────────────────────────────┐ │
│  │ After 12 months: ₹2,45,680          │ │
│  │ After 24 months: ₹3,25,360          │ │
│  │ After 36 months: ₹4,05,040          │ │
│  └───────────────────────────────────┘ │
│                                         │
│  [Continue] [Cancel]                     │
└─────────────────────────────────────────┘
...
│  ┌───────────────────────────────────┐ │
│  │ Goal: Buy House                     │ │
│  │ Goal Value: ₹66,40,000              │ │
│  │ Down Payment: ₹1,66,000             │ │
│  │ Remaining Gap: ₹64,74,000           │ │
│  └───────────────────────────────────┘ │
│                                         │
│  Your Current Finances                  │
│  ┌───────────────────────────────────┐ │
│  │ Average Income: ₹99,600            │ │
│  │ Average Expenses: ₹92,628          │ │
│  │ Average Savings: ₹6,972            │ │
│  └───────────────────────────────────┘ │
│                                         │
│  If keeping current situation           │
│  Monthly savings: ₹6,972                │
...
│  │ 🎯 Goal Value: ₹66,40,000          │ │
│  │ 💰 Down Payment: ₹1,66,000         │ │
│  │ ⚠️ Remaining Gap: ₹64,74,000       │ │
│  └───────────────────────────────────┘ │
│                                         │
│  ┌───────────────────────────────────┐ │
│  │ Buy Car                             │ │
│  │ 🎯 Goal Value: ₹16,60,000          │ │
│  │ 💰 Down Payment: ₹66,400            │ │
│  │ ⚠️ Remaining Gap: ₹15,93,600        │ │
│  └───────────────────────────────────┘ │
│                                         │
│  [➕ Add New]                           │
└─────────────────────────────────────────┘
