...
1. Go to **Reports** tab in bottom navigation
2. View **Financial Health** section:
   - Savings goal: $600 (20% of income)
   - Actual savings: $420
   - Progress bar: 70% - ACHIEVEMENT LEVEL: MEDIUM
   - Net Cashflow: +$280 [POSITIVE] with detailed formula
   - Budget remaining: $620 [STABLE] (62% budget ≈ 60% time)
   - Spending pace: 12% higher than previous month
   - Loan obligations: $420 [PAID]
   - Top 5 categories: Food (32%), Shopping (25%), Entertainment (18%), Transportation (15%), Other (10%)
3. View **Future Trend Forecast** section:
   - Expected remaining at end of month: +$230 [SURPLUS] with detailed formula
   - Goal achievement probability: 82% [NEAR ACHIEVE]
   - Upcoming loan payment: Day 25: $420 [SUFFICIENT FUNDS]
...
**Steps**:
1. From Reports screen, tap on menu item **💵 Income** in "Detailed Reports" section
2. View **Total Actual Income This Month**: $2,100
3. View **Recurring Income** section: Total $1,500 (Received: $1,300, Not yet received: $200), details for each item
4. View **Extra Income** section: Total $600 (Freelance: $300, Selling items: $100, Small bonus: $200), 5% increase from previous month
...
**Steps**:
1. From Reports screen, tap on menu item **🔥 Expenses** in "Detailed Reports" section
2. View **Total Actual Expenses This Month**: $1,820 (12% increase from previous month)
3. View **Recurring Expenses** section: Total $850 (Paid: $750, Not yet paid: $100), details for each item
4. View **Daily Expenses by Category** section: Food $650 (36%), Shopping $300 (16%), Transportation $210 (12%), Entertainment $140 (8%), Other $100 (5%)
5. View **Spending Surge** section: Food (+$120, +22%), Shopping (+$80, +35%)
...
2. View **Budget Overview This Month**:
   - Monthly budget: $1,000 (tap to view calculation details)
   - Spent: $380 (Daily expenses: $250, Expense variance: +$50, Income variance: -$20)
   - Remaining: $620
...
2. View **Actual Savings This Month**: $420 with detailed Net Cashflow formula
3. View **Savings Analysis** section: Savings account for 20% of income, 12% increase from previous month, end-of-month forecast: $510 (≈85% of goal)
4. View **Savings Account List** section: 3 accounts ($4,000, $500, $2,000), sorted by nearest maturity date
...
2. View **Loan Overview**: Current debt balance $65,000, Loan cost this month $420 (Principal: $350 + Interest: $70)
3. View **Nearest Payment** section: Day 25 → PAID, Next payment in 14 days
4. View **Monthly Payment Schedule** section: Last 3 months with amounts and status
5. View **Loan Analysis (Insights)** section: Paid in last 3 months: $1,260, Debt balance trend decreasing steadily, Interest accounts for 17% of payment, Late payment risk: LOW
