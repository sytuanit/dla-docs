...
<div style="margin:0.75rem 0 1.25rem;max-width:min(360px,100%);">
  <div style="position:relative;width:100%;padding-bottom:177.78%;height:0;background:#111;border-radius:10px;overflow:hidden;">
    <iframe style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"
      src="https://www.youtube.com/embed/7KEJlcqIfD8"
      title="YouTube"
      loading="lazy"
...
- [Pendapatan Berkala](./recurring-income.md) - Kelola sumber pendapatan rutin (gaji, sewa, dll)
- [Pendapatan Tambahan](./extra-income.md) - Catat pendapatan non-rutin
- [Pengeluaran Berkala](./recurring-expense.md) - Kelola pengeluaran rutin (utilitas, dll)
- [Pengeluaran Harian](./daily-expense.md) - Catat pengeluaran harian
- [Anggaran](./budget.md) - Rencanakan dan lacak anggaran bulanan
- [Tabungan](./savings.md) - Kelola rekening tabungan
- [Pinjaman Bank](./bank-debt.md) - Kelola pinjaman dan pembayaran utang
- [Tujuan Keuangan](./financial-goals.md) - Tetapkan dan lacak tujuan keuangan
