...
<p><strong>Einführungsvideo</strong></p>
<div style="margin:0.75rem 0 1.25rem;max-width:min(360px,100%);">
  <div style="position:relative;width:100%;padding-bottom:177.78%;height:0;background:#111;border-radius:10px;overflow:hidden;">
    <iframe style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"
      src="https://www.youtube.com/embed/NoIS1yQkGUE"
      title="YouTube"
      loading="lazy"
...
- [Wiederkehrendes Einkommen](./recurring-income.md) - Regelmäßige Einkommensquellen verwalten (Gehalt, Miete, etc.)
- [Zusatzeinkommen](./extra-income.md) - Nicht wiederkehrendes Einkommen erfassen
- [Wiederkehrende Ausgaben](./recurring-expense.md) - Wiederkehrende Ausgaben verwalten (Versorgungsunternehmen, etc.)
- [Tägliche Ausgaben](./daily-expense.md) - Tägliche Ausgaben erfassen
- [Budget](./budget.md) - Monatliche Budgets planen und verfolgen
- [Ersparnisse](./savings.md) - Sparkonten verwalten
- [Bankkredite](./bank-debt.md) - Kredite und Schuldenzahlungen verwalten
- [Finanzielle Ziele](./financial-goals.md) - Finanzielle Ziele setzen und verfolgen
