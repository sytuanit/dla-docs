...
**Günlük Yaşam Asistanı** kullanıcı kılavuzuna Türkçe olarak hoş geldiniz!

<p><strong>Tanıtım videosu</strong></p>
<div style="margin:0.75rem 0 1.25rem;max-width:min(360px,100%);">
  <div style="position:relative;width:100%;padding-bottom:177.78%;height:0;background:#111;border-radius:10px;overflow:hidden;">
    <iframe style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"
      src="https://www.youtube.com/embed/eL13TpRGpds"
      title="YouTube"
      loading="lazy"
...
- [Tekrarlanan Gelir](./recurring-income.md) - Düzenli gelir kaynaklarını yönetin (maaş, kira, vb.)
- [Ekstra Gelir](./extra-income.md) - Tekrarlanmayan geliri kaydedin
- [Tekrarlanan Giderler](./recurring-expense.md) - Tekrarlanan giderleri yönetin (faturalar, vb.)
- [Günlük Giderler](./daily-expense.md) - Günlük giderleri kaydedin
- [Bütçe](./budget.md) - Aylık bütçeleri planlayın ve takip edin
- [Tasarruf](./savings.md) - Tasarruf hesaplarını yönetin
- [Banka Kredileri](./bank-debt.md) - Kredileri ve borç ödemelerini yönetin
- [Finansal Hedefler](./financial-goals.md) - Finansal hedefler belirleyin ve takip edin
